...
public class BreakMultipleWordsWithNoSpaceIntoSpace {
	/**
	 * Dynamic programming version for breaking word problem. It returns null
	 * string if string cannot be broken into multipe words such that each word
	 * is in dictionary. Gives preference to longer words over splits e.g
	 * peanutbutter with dict{pea nut butter peanut} it would result in peanut
	 * butter instead of pea nut butter.
	 */
